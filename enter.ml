...
(*  "--debug_cfg",          Arg.Set Flag_parsing_c.debug_cfg , "  "; *)
    ...
    "--print-internals",         Arg.Set Flag_parsing_c.print_internals, "use a different pretty printer that reveals Coccinelle's internal types";
...
let __init_c_test_all = !c_test_all
let __init_cpp_test_all = !cpp_test_all
...
let reinitialize _ = (* clean start for invocation from OCaml *)
  ...
  c_test_all := __init_c_test_all;
  cpp_test_all := __init_cpp_test_all;
