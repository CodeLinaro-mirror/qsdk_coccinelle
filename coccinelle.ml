...
let __init_std_iso = !Cocciconfig.std_iso
let __init_std_h = !Cocciconfig.std_h
let __init_python_interpreter = !Cocciconfig.python_interpreter
...
let __init_print_internals = !Flag_parsing_c.print_internals
...
let __init_fresh_id_scripts = !Data.fresh_id_scripts
...
let __init_cocci_internals = !Flag_parsing_cocci.cocci_internals
...
let coccinelle arglist =
  ...
  Cocciconfig.std_iso := __init_std_iso;
  Cocciconfig.std_h := __init_std_h;
  Cocciconfig.python_interpreter := __init_python_interpreter;
  ...
  Flag_parsing_c.print_internals := __init_print_internals;
...
(*  Sexp_ast_c.show_info := __init_show_info;
  ...
  Data.fresh_id_scripts := __init_fresh_id_scripts;
  ...
  Flag_parsing_cocci.cocci_internals := __init_cocci_internals;
