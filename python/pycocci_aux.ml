...
let stringrep_internals = function
  Ast_c.MetaIdVal        s -> Printf.sprintf "MetaIdVal(%s)" s
| Ast_c.MetaAssignOpVal op -> Printf.sprintf "MetaAssignOpVal(%s)" (Internal_print_c.pr_assignOp op)
| Ast_c.MetaBinaryOpVal op -> Printf.sprintf "MetaBinaryOpVal(%s)" (Internal_print_c.pr_binaryOp op)
...
| Ast_c.MetaExprVal      (_,expr,_,_) -> Printf.sprintf "MetaExprVal(_,%s,_,_)" (Internal_print_c.pp_expression expr)
| Ast_c.MetaExprListVal  (_,expr_list) -> Printf.sprintf "MetaExprListVal(_,%s)" (Internal_print_c.pp_arg_list expr_list)
...
| Ast_c.MetaStmtListVal  (_,statxs,_) -> Printf.sprintf "MetaStmtListVal(_,%s,_)"     (Internal_print_c.pp_statement_seq_list statxs)
| Ast_c.MetaParamVal     (_,param) -> Printf.sprintf "MetaParamVal(_,%s)"     (Internal_print_c.pp_param param)
| Ast_c.MetaParamListVal (_,params) -> Printf.sprintf "MetaParamListVal(_,%s)"     (Internal_print_c.pp_param_list params)
| Ast_c.MetaTemplateParamVal     (_,param) -> Printf.sprintf "MetaTemplateParamVal(_,%s)"     (Internal_print_c.pp_template_param param)
| Ast_c.MetaTemplateParamListVal (_,params) -> Printf.sprintf "MetaTemplateParamListVal(_,%s)"     (Internal_print_c.pp_template_param_list params)
| Ast_c.MetaDParamListVal params -> Printf.sprintf "MetaDParamListVal(%s)"     (Internal_print_c.pp_define_param_list params)
| Ast_c.MetaFragListVal frags -> Printf.sprintf "MetaFragListVal(%s)"     (Internal_print_c.pp_string_fragment_list frags)
| Ast_c.MetaFmtVal fmt -> Printf.sprintf "MetaFmtVal(%s)"     (Internal_print_c.pp_string_format fmt)
| Ast_c.MetaAttrArgVal (_,name) -> Printf.sprintf "MetaAttrArgVal(_,%s)"     (Internal_print_c.pp_attr_arg name)
